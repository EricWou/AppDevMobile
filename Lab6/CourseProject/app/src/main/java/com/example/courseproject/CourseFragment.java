...
public class CourseFragment extends Fragment {
    ...
    Map<String, Object> courseHashMap;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("firebase", databaseRef.toString());

        courseHashMap = new HashMap<>();
        courseHashMap.put(c1.getCourse_no(), c1);
        courseHashMap.put(c2.getCourse_no(), c2);
        courseHashMap.put(c3.getCourse_no(), c3);
        courseHashMap.put(c4.getCourse_no(), c4);
        courseHashMap.put(c5.getCourse_no(), c5);
        courseHashMap.put(c6.getCourse_no(), c6);
        courseHashMap.put(c7.getCourse_no(), c7);
    }
        ...
        courseToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (item.getItemId() == R.id.course_option_1) {
                    ...
                    Toast.makeText(getActivity(), "Course Operation", Toast.LENGTH_SHORT).show();
                }
        ...
        */
        ...
        writeToFirebaseButton.setOnClickListener((new View.OnClickListener() {
            public void onClick(View view) {
                ...
                //on Firebase website -> Realtime Database -> Rules -> .read/.write need to not be false

                //To add the first element of an Array (not necessary to do first)
                ...
                //To store the entire hashmap
                databaseRef.child("Courses").updateChildren(courseHashMap);
                    ...
                    public void onClick(View view) {
                        ...
                        databaseRef.child("Courses").addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                courseListTextView = (TextView) v.findViewById(R.id.course_list_text_view);
                                courseListTextView.setText(allCourses);
                            }
