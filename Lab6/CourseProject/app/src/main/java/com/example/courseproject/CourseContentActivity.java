    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callCourseWebServiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //String uri = "localhost:8080/WebHelloWorldRESTProject/rest/HiHi/specify/Eric";
                String uri = "http://api.zippopotam.us/us/98121";

                new AsyncHttpClient().get(uri, new AsyncHttpResponseHandler() {
                    @Override
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        String stringResponse = new String(responseBody);
                        courseContentTextView.setText(stringResponse);
                    }
