package com.example.studentgradeproject.Model;
...
public class Grade {
    ...
    public double calculate_GradeAverage() {
        double assignmentPercentage = (double)(s_grade_Assignment1 + s_grade_Assignment2 + s_grade_Assignment3)/3 * 40/100;
        double midtermPercentage = (double)(s_grade_Mid_Term) * 30/100;
        double finalExamPercentage = (double)(s_grade_Final_Term) * 30/100;

        return assignmentPercentage + midtermPercentage + finalExamPercentage;
    }
}
